...
<head>
    ...
    <link rel="shortcut icon" href="../assets/Sena_Colombia_logo.ico" />
</head>
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <img class="rounded mx-auto d-block" src="../assets/Sena_Colombia_logo.ico" alt="Girl in a jacket" width="400" height="400" >
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
